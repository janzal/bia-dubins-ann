...
namespace imr { namespace gui {
   ...
   template<class T>
      class AddCoords {
         public:
            ...
            AddCoords(const typename T::CoordsArray& coordsArray, const_iterator begin, const_iterator end) : accessor(coordsArray), begin(begin), end(end) {}
   ...
   class CCanvasBase {
      public:
         ...
         template<class T>
            CCanvasBase& operator<<(const AddCoords<T>& accessor) {
               for (typename AddCoords<T>::const_iterator it = accessor.begin; it != accessor.end; it++) {
                  *this << accessor.getX(it) << accessor.getY(it);
               }
               return *this;
            }
   ...
   template <class T>
      class CCanvas : public CCanvasBase {
         public:
            typedef T Point;
