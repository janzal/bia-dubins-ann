...
namespace imr { namespace gui { namespace render {
   ...
   class CRenderer {
	 ...
	 typedef imr::gui::manager::CObject Object;
	 ...
	 /// @param maxY 
	 /// 
	 virtual void setArea(double minX, double maxX, double minY, double maxY)  = 0;
	 ...
	 /// @param oX 
	 /// @param oY 
	 virtual void canvas2Real(double iX, double iY, double* oX, double* oY) = 0;
	 ...
	 /// @param oX 
	 /// @param oY 
	 virtual void real2Canvas(double iX, double iY, double* oX, double* oY) = 0;

	 virtual void redraw(void) = 0;

	 virtual void drawPoint(double iX, double iY, const std::string& tags, const CShape& shape) = 0;
	 ...
	 /// 
	 virtual bool open(TObjectType object, const std::string& tag, const CShape& shape) = 0;

	 /// 
	 /// @brief close current object opened by open
	 /// 
	 /// @return true if given object was successfully close (e.g. false is return if object require more than one poits, ...)
	 /// 
	 ...
	 //              virtual void setExportDimension(int width, int height) = 0;
	 ...
	 /// @param lst 
	 /// ----------------------------------------------------------------------------
	 virtual void getObjectsNames(double x, double y, std::list<std::string>& lst) = 0;
	 ...
	 /// @param lst 
	 /// ----------------------------------------------------------------------------
	 virtual void getObjects(double x, double y, Manager::ObjectList& objects) = 0;
	 ...
	 /// @return 
	 /// ----------------------------------------------------------------------------
	 virtual Manager& getManager(void) {
	    assert_usage(false, "Manager functionality is not supported by this rendered");
	    return *(Manager*)0; 
	 }

	 virtual void setBackgroundColor(const SColor& color) {
	    assert_usage(false, "Background color is not supported by this rendered");
	 }
