...
//----------------------------------------------------------------------------
std::string & SGuiEvent::str(void) {
   return StrEvent[type];
}

//----------------------------------------------------------------------------
//std::string & SGuiEvent::str(events::TType type) {
std::string & SGuiEvent::str(TType type) {
   return StrEvent[type];
}
...
//----------------------------------------------------------------------------
void SGuiEvent::setMouseState(int iState) {
   mouseState = (TMouseState)iState;
}

//----------------------------------------------------------------------------
//bool SGuiEvent::mouseButton(events::TMouseState btn) {
bool SGuiEvent::mouseButton(TMouseState btn) {
