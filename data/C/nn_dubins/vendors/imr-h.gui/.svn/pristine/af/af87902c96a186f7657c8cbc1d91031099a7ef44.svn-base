...
/// ----------------------------------------------------------------------------
SRendererObject::SRendererObject(ObjectType type, const CShape& shape) : shape(shape), type(type), size(0) {
...
/// ----------------------------------------------------------------------------
void SRendererObject::simplePrint(std::ostream& out, const CCoordsTransform& transform) {
   switch(type) {
      case AREA:
         out << "[AREA]";
         break;
...
/// ----------------------------------------------------------------------------
//std::ostream & SRendererObject::operator<<(std::ostream & out) {
//}
